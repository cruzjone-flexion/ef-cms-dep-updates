function runMigrationToExperimentalEnv(
    async,
    inquirer,
) {
        ...
        const QUESTION = [
            {
                type: 'confirm',
                name: KEY,
                message: 'Do you want to run a migration to an experimental enviornment?',
                default: false,
            },
        ];
    ...
    return function (options, callback) {
        const TASKS = [
            (continuation) => askUserIfWantToRunAMigrationOnExperimental(continuation),
